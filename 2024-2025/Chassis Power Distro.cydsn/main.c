...
void Initialize(void) {
    ...
    railStateAssign(ALL_RAIL_ON);
    //char str_buffer[32];
    static int arr[3];
    Print("Rail States Initialized\n\r");
    ...
    overCurrentLimitAssign(ADDR_3_3V, 0xFFFFFFFF);
    overCurrentLimitAssign(ADDR_5V, 0xFFFFFFFF);
    overCurrentLimitAssign(ADDR_12V, 0xFFFFFFFF);
