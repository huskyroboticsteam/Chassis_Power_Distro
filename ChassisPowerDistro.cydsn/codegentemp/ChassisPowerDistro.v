// ======================================================================
// ChassisPowerDistro.v generated from TopDesign.cysch
// 12/01/2022 at 17:47
...
module top ;
	...
	wire [0:0] tmpOE__LED_RED_2_net;
	wire [0:0] tmpFB_0__LED_RED_2_net;
	wire [0:0] tmpIO_0__LED_RED_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_RED_2_net;
	electrical [0:0] tmpSIOVREF__LED_RED_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_RED_2
		 (.oe(tmpOE__LED_RED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_RED_2_net[0:0]}),
		  .io({tmpIO_0__LED_RED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_RED_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_RED_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_RED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_PURPLE_net;
	wire [0:0] tmpFB_0__LED_PURPLE_net;
	wire [0:0] tmpIO_0__LED_PURPLE_net;
	wire [0:0] tmpINTERRUPT_0__LED_PURPLE_net;
	electrical [0:0] tmpSIOVREF__LED_PURPLE_net;

	cy_psoc3_pins_v1_10
		#(.id("819017ee-968c-4e41-85b9-32495164fb83"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_PURPLE
		 (.oe(tmpOE__LED_PURPLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_PURPLE_net[0:0]}),
		  .io({tmpIO_0__LED_PURPLE_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_PURPLE_net),
		  .interrupt({tmpINTERRUPT_0__LED_PURPLE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_PURPLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cde487cd-ed8a-43a4-887b-2e51529f50fe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
